...
def Find(string):
    print(string)
    str = 'this is a 1234 test lol 04543'
...
def VerifyEmail():
    ...
    driver.get(UrlToUse)
    time.sleep(4)
    print('Claimed the Discord account')
    deleteMail()
...
def checkMails():
    ...
    if length == 0:
        ...
        #if subject == 'Verify Email Address for Discord':
         #   print('Email from Discord has arrived, claiming the account...')
        #VerifyEmail()
